...
import com.e.wildebeest.exercises.StartFragment.OnListFragmentInteractionListener;
...
public class StartRecyclerViewAdapter extends RecyclerView.Adapter<StartRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        String msg = Tools.secondsToMinutesLong(mValues.get(position).runSeconds);
        holder.mContentView.setText(msg);
